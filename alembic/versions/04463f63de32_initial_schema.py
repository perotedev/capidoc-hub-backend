...
Revision ID: 04463f63de32
Revises: 
Create Date: 2026-07-19 22:13:24.340988
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['admin_id'], ['users.id'], name='fk_organizations_admin_id', ondelete='RESTRICT', use_alter=True),
